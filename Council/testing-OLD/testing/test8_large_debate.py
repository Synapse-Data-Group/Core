"""
TEST 8: LARGE-SCALE DEBATE - FULL COUNCIL CAPABILITIES
...
- Minimum 50 agents suggested, but moderator decides actual number
...
GOALS:
1. Test Council at scale (50+ agents)
2. Measure performance vitals with all systems
...
def run_test8():
    """
    LARGE-SCALE DEBATE TEST
    Moderator builds 50+ agent team and produces deliverable report
    """
    
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    test_folder = f"testing/output/test8_debate_{timestamp}"
    os.makedirs(test_folder, exist_ok=True)
    
    print("\n" + "🐝"*40)
    print("\n  TEST 8: LARGE-SCALE DEBATE")
    ...
    # The task
    problem = """Should humanity pursue digital consciousness uploading and mind-substrate independence, 
or is biological existence fundamental to human identity? Consider philosophical, ethical, technological, 
and societal implications of becoming post-biological entities."""
    ...
    doc = WhitepaperDocumenter("test8_debate")
...
MINIMUM: 50 agents suggested, but you decide the optimal number based on task complexity.
...
"""
    ...
    print("\n" + "="*80)
    print("TEST 8 COMPLETE - LARGE-SCALE DEBATE")
    print("="*80)
...
if __name__ == "__main__":
    print("\n" + "⚡"*40)
    print("\n  COUNCIL FRAMEWORK - TEST 8")
    print("  LARGE-SCALE DEBATE (50+ AGENTS)")
    print("  Moderator → Team → Debate → Deliverable")
    print("\n" + "⚡"*40)
    
    input("\nPress ENTER to run Test 8 (Large-Scale Debate)...")
